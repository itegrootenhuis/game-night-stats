  ...
  return (
    <div className="w-full max-w-md">
      <div className="text-center mb-8">
        ...
        <div className="h-8 w-48 bg-zinc-800 rounded animate-pulse mx-auto mb-2" />
        <div className="h-4 w-64 bg-zinc-800 rounded animate-pulse mx-auto" />
      </div>
      <div className="h-14 bg-zinc-800 rounded-xl animate-pulse mb-6" />
      <div className="h-14 bg-zinc-800 rounded-xl animate-pulse mb-4" />

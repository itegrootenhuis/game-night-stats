    ...
    return (
      <main className="min-h-screen flex items-center justify-center p-4">
        <div className="w-full max-w-md text-center">
          ...
          <Link
            href="/login"
            className="inline-flex items-center justify-center px-6 py-3 rounded-xl bg-zinc-800 text-white hover:bg-zinc-700 transition-colors"
          >
            Back to Login
          </Link>
        </div>
    ...
    <main className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-400 mt-1">Start tracking your game night victories</p>
        </div>
